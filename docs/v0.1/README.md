...
- [Phase 4 — Layout and state inventory](phase-04-layout-state-inventory.md)
...
- Phase 7 — Identity and community: `complete`
- Current phase: Phase 8 — Free deployment and operations (`ready`)
